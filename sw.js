...
async function syncSavedRecommendations() {
    try {
        // Service workers do not have access to localStorage; implement backend sync here if needed.
        console.log('Service Worker: syncSavedRecommendations noop (no backend)');
    } catch (error) {
...
async function syncAnalytics() {
    try {
        // Service workers do not have access to localStorage; implement analytics sync here if needed.
        console.log('Service Worker: analytics sync noop');
    } catch (error) {
